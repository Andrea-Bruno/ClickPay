    ...
    private readonly Dictionary<string, Dictionary<string, string>> _translations = new()
        {
            ["it"] = new()
            {
                ...
                ["WalletPrimaryAddressLabel"] = "Indirizzo di ricezione (0):",
                ...
                ["SendFeeNoticeSolana"] = "Le transazioni {0} richiedono SOL per coprire le fee di rete.",
                ["SendFeeWarningLowSol"] = "Saldo SOL insufficiente: {0} SOL disponibili, necessari almeno {1} SOL.",
                ["SendFeeNoticeNativeSol"] = "Le transazioni SOL consumano una piccola quantità di saldo come fee. Mantieni sempre un margine disponibile.",
            ...
            ["en"] = new()
            {
                ...
                ["WalletPrimaryAddressLabel"] = "Receiving address (index 0):",
                ...
                ["SendFeeNoticeSolana"] = "{0} transactions require SOL to cover network fees.",
                ["SendFeeWarningLowSol"] = "SOL balance too low: {0} SOL available, at least {1} SOL required.",
                ["SendFeeNoticeNativeSol"] = "SOL transfers consume a small portion of your balance as network fees. Keep a safety margin available.",
            ...
            ["fr"] = new()
            {
                ...
                ["WalletPrimaryAddressLabel"] = "Adresse de réception (index 0) :",
                ...
                ["SendFeeNoticeSolana"] = "Les transactions {0} nécessitent des SOL pour couvrir les frais réseau.",
                ["SendFeeWarningLowSol"] = "Solde SOL insuffisant : {0} SOL disponibles, au moins {1} SOL requis.",
                ["SendFeeNoticeNativeSol"] = "Les transferts SOL consomment une petite partie du solde en frais. Gardez une marge de sécurité.",
            ...
            ["es"] = new()
            {
                ...
                ["WalletPrimaryAddressLabel"] = "Dirección de recepción (índice 0):",
                ...
                ["SendFeeNoticeSolana"] = "Las transacciones de {0} requieren SOL para cubrir las comisiones de la red.",
                ["SendFeeWarningLowSol"] = "Saldo SOL insuficiente: {0} SOL disponibles, se requieren al menos {1} SOL.",
                ["SendFeeNoticeNativeSol"] = "Las transferencias SOL consumen una pequeña parte del saldo como comisión. Mantén un margen disponible.",
            ...
            ["de"] = new()
            {
                ...
                ["WalletPrimaryAddressLabel"] = "Empfangsadresse (Index 0):",
                ...
                ["SendFeeNoticeSolana"] = "{0}-Transaktionen benötigen SOL, um die Netzwerkgebühren zu decken.",
                ["SendFeeWarningLowSol"] = "SOL-Guthaben zu niedrig: {0} SOL verfügbar, mindestens {1} SOL erforderlich.",
                ["SendFeeNoticeNativeSol"] = "SOL-Überweisungen verbrauchen einen kleinen Teil des Guthabens als Gebühr. Halten Sie einen Sicherheitspuffer bereit.",
